    ...
    <div class="container">
        ...
        <div class="row col-md-14">
            ...
            <table class="table table-striped table-bordered table-hover">
                ...
                <%
                    List<Order> record = (List<Order>) request.getAttribute("orderHistory");
                    if (record.size() != 0) {
                        for (Order o : record) {
                            out.println("<tr>");
                            ...
                            out.println("<td><a href=\"OrderHistoryDetailLogic?cusID=" + customer_num + "&id=" + o.getId()+ "&keyword=&direction=ASC"+"\">View Details</a></td>");
                            out.println("</tr>");
                        }
                    }
                    else {
