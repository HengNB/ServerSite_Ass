...
<div class="content-section">
    <div class="container">
        <form class="form-inline md-form mr-auto mb-6" action="PaymentDetailLogic" method="get">
        ...
        <div class="row col-md-14">
            <table class="table table-striped table-bordered table-sm">
                ...
                <%
                    List<Payment> staffs = (List<Payment>) request.getAttribute("staffs");
                    if (staffs.size() != 0) {
                        for (Payment t : staffs) {
                            out.println("<tr>");
        ...
        <div><button class="open-button" onclick="openForm()">Open Form</button>
            <div class="form-popup" id="myForm">
                <form action="PaymentController" class="form-container" method="post">
                    ...
                    <fieldset>
                        ...
                        <select name ="customerNumber" id ="cusNum" style=" width: 200px">
                        ...
                        <br>Check Number: <input type="text" name="checkNumber" />
                        <br>Payment Date: <input type="text" name="paymentDate" />
                        <br>Amount: <input type="number" step=".01" name="amount" />
                    </fieldset>
