...
<div class="content-section">
    <div class="container">
        <h2 style="color: black">Update / Delete for PaymentID = <%=payment.getId().getChecknumber()+payment.getId().getCustomernumber() %>  </h2>
        ...
        <form action="PaymentController" method="post">
            <table>
                <tr>
                    ...
                    <td>
                        <%
                            out.println("<input type=\"text\" name=\"customerNumber\" readonly value=" + payment.getId().getCustomernumber());
                        %>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <%
                            out.println("<input type=\"text\" name=\"checkNumber\" readonly value=" + payment.getId().getChecknumber());
                        %>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <%
                            out.println("<input type=\"number\" name=\"amount\" step=\".01\" value=" + payment.getAmount());
                        %>
                    </td>
                </tr>
            </table>
