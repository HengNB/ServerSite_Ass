...
<div class="content-section">
    <div class="container">
        ...
        <div class="row col-md-14">
                ...
                <%
                    ...
                    if (staffs.size() != 0) {
                        for (Product t : staffs) {
                            ...
                            out.println("<td><a href=\"ProductController?id=" + t.getId() + "\">Update</a></td>");
                            out.println("<td><a href=\"ProductController?id=" + t.getId() + "\">Delete</a></td>");
                            out.println("</tr>");
                        }
                    } else {
                        out.println("<tr>");
            ...
            <button class="btn aqua-gradient btn-rounded btn-sm my-0 btn btn-success" onclick="showProductForm()">Add Product</button>
        </div>
        ...
        <div class="text-center">
            <nav aria-label="Navigation for staffs">
                <ul class="pagination">
                    ...
                    <li class="page-item">
                        <% out.println("<a class=\"page-link\" href=\"" + "ProductDetailLogic?recordsPerPage=" + recordsPerPage
        ...
        <div class="form-popup" id="addProductForm">
            <form onsubmit="return validateForm()" name = "addProductForm" action="ProductController" class="form-container" method="post">
                <legend>Add Product :</legend>
                <div class="form-group">
                    <label id="productCode">Product Code : </label>
                ...
                <div class="form-group">
                    ...
                    <select name ="productLine" id="Product_Line" style="width: 200px">
                        out.println("<option value="" selected>Please select a Product Line</option>");
                        <%
                            List<Productline> productline = (List<Productline>) request.getAttribute("productline_records");

                            for (Productline t : productline) {
                ...
                <div class="form-group">
                    <label id = "productScale">Product Scale: </label>
                    <input type="text" name="productScale" />
                </div>

                <div class="form-group">
                    <label id = "productVendor">Product Vendor: </label>
                    <input type="text" name="productVendor" />
                </div>

                <div class="form-group">
                    <label id="productDescription">Product Description: </label>
                    <textarea name="productDescription" rows="3" cols="50"></textarea>
                </div>

                <div class="form-group">
                    <label id = "quantityInStock">Quantity In Stock: </label>
                    <input type="number" name="quantityInStock" />
                </div>

                <div class="form-group">
                    <label id = "buyPrice">Buy Price: </label>
                    <input type="number" step=".01" name="buyPrice" />
                </div>

                <div class="form-group">
                    <label id = "msrp">MSRP: </label>
                    <input type="number" step=".01" name="msrp" />
                </div>
