...
<div class="content-section">
    <div class="container">
        <h2 style="color: black">Update / Delete for Product <%=product.getId()%> </h2>
        <h5 style ="color: #285e8e"> <i>** Update : Data will be updated once you press on the update button</i></h5>
        <hr style="color: black">

        <%--POST THE UPDATE/DELETE--%>
        <form action="ProductController" method="post" style="color: black">
            <table>
                <tr>
                    <td>Product Code :</td>
                    <td>
                        <b>
                            <%
                                ...
                                out.println("<input type=\"hidden\" name=\"productCode\" readonly value=" + product.getId() + ">");
                            %>
                        </b>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <%
                            out.println("<input type=\"text\" name=\"productName\" value=\"" + product.getProductname() + "\"");
                        %>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <%
                            out.println("<select name=\"productLine\" id=\"productLine\" style=\"width: 200px\">");
                            List<Productline> productlines = (List<Productline>) request.getAttribute("productline_records");
                            for (Productline productline : productlines) {
                                if (productline.getId().equals(product.getProductline())) {
                                    out.println("<option value=\"" + productline.getId() + "\" selected>" + productline.getId() + "</option>");
                                } else{
                                    out.println("<option value=\"" + productline.getId() + "\">" + productline.getId() + "</option>");
                                }
                            }
                            out.println("</select>");
                        %>
                ...
                <tr>
                    ...
                    <td>
                        <%
                            out.println("<textarea rows=\"4\" cols=\"30\" name=\"productDescription\">" + product.getProductdescription() + "</textarea>");
                        %>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <%
                            out.println("<input type=\"number\" name=\"quantityInStock\" step=\"1\" value=\"" + product.getQuantityinstock() + "\"");
                        %>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <%
                            out.println("<input type=\"number\" name=\"buyPrice\" step=\".01\" value=\"" + product.getBuyprice() + "\"");
                        %>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <%
                            out.println("<input type=\"number\" name=\"msrp\" step=\".01\" value=\"" + product.getMsrp() + "\"");
                        %>
                    </td>
                </tr>
            </table>
