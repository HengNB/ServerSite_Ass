...
<div class="content-section">
    <div class="container">
        ...
        <div class="row col-md-12">
            ...
            <button class="btn aqua-gradient btn-rounded btn-sm my-0 btn btn-success" onclick="showOrderDetailsForm()">Add Product</button>
            <br>
            <form action="OrderLogic", method="get", style="text-align: center">
        ...
        <div class="form-popup" id="addOrderDetailForm">
...
<script>
    function showOrderDetailsForm() {
        document.getElementById("addOrderDetailForm").style.display = "block";
    }
    function closeForm() {
        document.getElementById("addOrderDetailForm").style.display = "none";
    }
