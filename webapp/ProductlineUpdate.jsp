...
<%
    Productline productline = (Productline) request.getAttribute("productline_detail_single");
%>
...
<div class="content-section">
    <div class="container">
        <h2 style="color: black">Update / Delete for Product Line <%=productline.getId()%> </h2>
        <h5 style ="color: #285e8e"> <i>** Update : Data will be updated once you press on the update button</i></h5>
        <hr style="color: black">

        <%--POST THE UPDATE/DELETE--%>
        <form action="ProductlineController" method="post" style="color: black">
            <table>
                <tr>
                    <td>Product Line: </td>
                    <td>
                        <%
                            out.println("<input type=\"text\" name=\"productLine\" readonly value=\"" + productline.getId() + "\"");
                        %>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <%
                            out.println("<textarea rows=\"4\" cols=\"60\" name=\"textDescription\">" + productline.getTextdescription() + "</textarea>");
                        %>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <%
                            out.println("<input type=\"text\" name=\"htmlDescription\" value=\"" + productline.getHtmldescription() + "\"");
                        %>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <%
                            out.println("<input type=\"text\" name=\"image\" value=\"" + productline.getImage() + "\"");
                        %>
                    </td>
                </tr>
            </table>
