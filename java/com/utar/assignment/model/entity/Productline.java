...
@NamedQuery(name = "Productline.findbyId", query = "SELECT pl FROM Productline pl WHERE pl.id = :id")
@NamedQuery(name = "Productline.findbyAll", query = "SELECT pl FROM Productline pl")
