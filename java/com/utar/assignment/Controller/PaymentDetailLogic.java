...
public class PaymentDetailLogic extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            List<Payment> lists = empbean.readPayment(currentPage,recordsPerPage,keyword,direction);
            request.setAttribute("staffs", lists);
            List<Customer> customer_list = empbean.getAllCustomerRecords();
            request.setAttribute("customer_records", customer_list);
